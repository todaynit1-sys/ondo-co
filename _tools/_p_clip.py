  ...
  <div class="wrap">
    ...
    <div class="spots">
      ...
      <div class="spot rv"><span class="spot-k">전환</span>
        <h3>영상 아래에 주소 하나만 있으면 된다</h3>
        <p>영상으로 관심이 생긴 사람이 바로 갈 곳이 프로필의 홈페이지 주소입니다. 웹과 함께할 때 효과가 큽니다.</p></div>
...
<section class="sec">
  <div class="wrap">
    ...
    <h2 class="rv">영상을 보고 온 사람이 갈 곳</h2>
    <p class="lede rv">영상은 관심을 만들고, 그다음은 그 관심이 도착할 자리가 필요합니다.</p>
    __NEXTS__
  </div>
</section>
"""
