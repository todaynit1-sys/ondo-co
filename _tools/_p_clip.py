...
<section class="phead">
  <div class="wrap phead-in">
    ...
    <dl class="phead-facts">
      <div class="phead-fact"><dt>30초 1편</dt><dd>25<small>만원</small></dd></div>
      <div class="phead-fact"><dt>60초 1편</dt><dd>60<small>만원</small></dd></div>
  ...
  <div class="wrap svc-grid">
    <div>
      ...
      <div class="svc-cta rv">
        <span class="svc-price">30초 25만원<small>60초 60만원</small></span>
...
<section class="sec" id="price">
  <div class="wrap">
    ...
    <p class="lede rv">길어지면 장면 수가 늘고, 장면이 늘면 다시 만들 때의 작업량이 급격히 커집니다.
      그래서 <b>30초와 60초의 금액 차이가 큽니다.</b> 기획·시나리오·자막·썸네일이 모두 포함된 금액입니다.</p>
...
body = (body
  ...
  .replace("__FAQ__", faq([
     ...
     ("왜 60초가 30초의 두 배가 넘나요?",
      "길이가 두 배면 장면 수가 두 배 이상 늘고, 장면이 늘면 마음에 안 드는 부분이 생길 확률과 다시 만들 때의 작업량이 함께 커집니다. 60초는 구성도 더 촘촘하게 짜야 합니다. 그 차이를 금액에 반영했습니다."),
...
LD = {"@context": "https://schema.org", "@type": "Service", "name": "온도 클립",
      ...
      "offers": {"@type": "AggregateOffer", "priceCurrency": "KRW", "lowPrice": "250000", "highPrice": "900000"}}

page("clip/index.html",
     "온도 클립 — 촬영 없이 만드는 AI 홍보 영상 | 온도컴퍼니",
     "카메라도 소재도 필요 없습니다. 알리고 싶은 내용만 주시면 AI로 화면과 목소리를 만들어 세로 영상으로 완성합니다. 30초 25만원, 60초 60만원. 동물·아나운서 등 연출 선택.",
