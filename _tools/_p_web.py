...
<section class="sec sec-mist" id="price">
  <div class="wrap">
    ...
    <div class="plan-note rv">
      ...
      <b>연락 방법</b> · 기본은 <b>전화 바로걸기 + 카톡 문의 버튼</b>입니다. 이메일로 받는 문의폼은 외부 무료 서비스를 연결하는 옵션입니다<br>
...
body = (body
  ...
  .replace("__FAQ__", faq([
     ...
     ("손님 문의는 어떻게 받나요? 이메일로도 오나요?",
      "기본은 <b>전화 바로걸기</b>와 <b>카톡 문의 버튼</b>입니다. 손님이 누르면 바로 통화나 대화창으로 넘어가서, 사장님이 따로 관리할 게 없습니다. 이메일로 받는 문의폼도 연결해 드릴 수 있는데, 이건 외부 무료 서비스에 사장님 명의 계정을 만들어야 하고 무료 구간에 월 건수 제한이 있습니다. 그래서 <b>기본 상품에는 넣지 않고 옵션</b>으로 두었습니다."),
     ("만든 사이트는 제 것이 되나요?",
