...
WEB_PLANS = "".join([
 plan("베이직", "일단 주소부터 필요한 경우", "5", "~8만원",
      ["원페이지 3~4섹션", "모바일 반응형", "전화 바로걸기 버튼", "카톡 공유 미리보기", "배포 주소 + 소스", "무료 수정 2회"], "베이직 문의", K),
 plan("스탠다드", "손님을 실제로 받는 가게라면", "10", "~15만원",
      ["5~7섹션 · 베이직 전부 포함", "갤러리 · 메뉴 · 전후 비교", "문의폼 (이메일 수신)", "네이버 지도 · 오시는 길", "사진 보정 · 웹 최적화", "무료 수정 2회"],
      "스탠다드 문의", K, best=True, tag="가장 많이 선택"),
 plan("프리미엄", "페이지를 더 나눠야 하는 경우", "20", "만원~",
      ["스탠다드 전부 포함", "서브페이지 1~2개", "커스텀 도메인 연결", "업종별 맞춤 기능 협의", "무료 수정 2회"], "프리미엄 문의", K),
])
CLIP_PLANS = "".join([
 plan("싱글", "한 편 만들어 보고 정하시려면", "20", "만원 · 1편",
      ["30초 세로 영상 1편", "구성 기획 · 컷 편집", "자막 · 저작권 안전 배경음", "썸네일 1컷", "업로드 문구 초안", "무료 수정 1회"], "싱글 문의", K),
 ...
 plan("월 관리", "꾸준히 올려야 효과가 납니다", "68", "만원 · 월 4편",
      ["매주 1편 · 월 4편 (편당 17만원)", "패키지 구성 전부 포함", "매달 촬영 주제 · 가이드 제공", "반응 보고 다음 편 조정", "월 단위 해지 가능"], "월 관리 문의", K),
])
AI_PLANS = "".join([
 ...
 plan("결과물 + 전략", "이력서·면접까지 정리하려면", "15", "~18만원",
      ...
      "결과물 + 전략 문의", K, best=True, tag="가장 많이 선택"),
...
NOTE_COMMON = (
 ...
 "<b>세금</b> · 표기 금액은 모두 부가세 별도입니다. 세금계산서 발행 가능합니다<br>"
...
PANELS = (
 panel("pp-web", "pt-web", WEB_PLANS,
       ...
       "<b>도메인</b> · 구입비는 별도이며 소유는 본인 명의로 등록해 드립니다<br>" + NOTE_COMMON) +
 panel("pp-clip", "pt-clip", CLIP_PLANS,
       ...
       "<b>해지</b> · 월 관리는 월 단위로 해지하실 수 있고 위약금이 없습니다<br>" + NOTE_COMMON, hidden=True) +
...
body = (body
  ...
  .replace("__FAQ__", faq([
    ...
    ("추가 비용이 생기는 경우는 언제인가요?",
     "① 무료 수정 횟수를 넘긴 수정, ② 처음 정한 범위 밖의 기능·섹션 추가, ③ 커스텀 도메인 연결, ④ 온도 AI에서 유료 AI 서비스가 필요한 경우입니다. 모두 <b>발생 전에 먼저 말씀드리고</b> 동의하시면 진행합니다."),
    ("계약금이나 선입금이 있나요?",
...
page("pricing/index.html",
     ...
     "반응형 홈페이지 5만원부터, 홍보 숏폼 30초 편당 20만원, 취업용 AI 결과물 8만원부터. 포함 사항과 추가 비용을 미리 구분해 적어 두었습니다. 부가세 별도.",
     body, P, "pricing/")
