...
NOTE_COMMON = (
 ...
 "<b>증빙</b> · 세금계산서·현금영수증이 필요하시면 문의 때 먼저 말씀해 주세요. 가능한 방법을 확인해서 알려 드립니다<br>"
...
PANELS = (
 panel("pp-web", "pt-web", WEB_PLANS,
       "<b>옵션</b> · 커스텀 도메인 연결 +2~3만원 / 섹션 추가 건당 1~2만원 / 문의폼 연결 +1~2만원<br>"
...
page("pricing/index.html",
     ...
     "반응형 홈페이지 5만원부터, 홍보 숏폼 30초 편당 20만원, 취업용 AI 결과물 8만원부터. 포함 사항과 추가 비용을 미리 구분해 적어 두었습니다.",
     body, P, "pricing/")
