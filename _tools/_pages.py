    ...
    <div class="svcs-wrap ld ld6">
      ...
      <div class="svcs">
        ...
        <a class="sc" data-svc="clip" href="clip/">
          ...
          <h2>온도 클립</h2>
          <p class="sc-role">피드에 보이게 · 홍보 숏폼</p>
          <p class="sc-desc">검색하지 않은 사람에게 닿는 통로. 찍어둔 사진·영상만 보내주시면 편집·자막·음악까지 끝내서 드립니다.</p>
          <ul class="sc-chips"><li>30초 세로 영상</li><li>자막 스타일</li><li>저작권 안전 배경음</li><li>썸네일</li><li>규격 동시 출력</li></ul>
          <dl class="sc-meta">
            <div><dt>편당 가격</dt><dd>20<small>만원</small></dd></div>
            <div><dt>제작 기간</dt><dd>2~3<small>일</small></dd></div>
          </dl>
  ...
  <div class="wrap">
    ...
    <div class="spots">
      ...
      <div class="spot rv"><span class="spot-k">피드</span>
        ...
        <p>검색은 이미 우리를 아는 사람만 합니다. 모르는 사람에게 닿는 통로는 짧은 영상뿐입니다.</p></div>
...
<section class="sec sec-mist svc s-clip rev" id="s-clip">
  <div class="wrap svc-grid">
    <div>
      ...
      <p class="svc-role rv">피드에 보이게 — 홍보 숏폼</p>
      <p class="svc-desc rv">검색은 우리를 이미 아는 사람만 합니다. 모르는 사람에게 닿으려면 그 사람이 넘기던 화면에 우리가 끼어들어야 합니다. 찍어둔 사진·영상만 보내주시면 편집·자막·음악까지 끝내서 드립니다.</p>
      <ul class="svc-list rv">
        <li><span><b>30초 기준 세로 영상</b> — 릴스·쇼츠·틱톡 규격</span></li>
        <li><span><b>자막 + 스타일</b> — 소리 없이 봐도 내용이 전달되게</span></li>
        <li><span><b>저작권 안전한 배경음</b> — 상업적 사용 가능한 음원만</span></li>
...
LD_ORG = {
 ...
 "@graph": [
  {"@type": "ProfessionalService", "@id": SITE + "#org", "name": "온도컴퍼니",
   ...
   "description": "소규모 사업자와 취업 준비생을 위해 반응형 홈페이지, 홍보 숏폼, 취업용 AI 결과물을 제작하는 온라인 제작소.",
   "url": SITE, "priceRange": "₩₩",
   "areaServed": {"@type": "Country", "name": "대한민국"},
   "knowsAbout": ["홈페이지 제작", "반응형 웹", "랜딩페이지", "숏폼 영상 편집", "취업 포트폴리오", "바이브코딩", "AI 웹앱 제작"],
   "sameAs": [KAKAO],
   "makesOffer": [
     {"@type": "Offer", "itemOffered": {"@type": "Service", "name": "온도 웹", "serviceType": "반응형 홈페이지 제작", "url": SITE + "web/"}, "priceCurrency": "KRW", "price": "50000"},
     {"@type": "Offer", "itemOffered": {"@type": "Service", "name": "온도 클립", "serviceType": "홍보 숏폼 영상 제작", "url": SITE + "clip/"}, "priceCurrency": "KRW", "price": "200000"},
...
page("index.html",
     "온도컴퍼니 ONDO° — 홈페이지 · 홍보 숏폼 · 취업용 AI 결과물",
     "보여야 연락이 옵니다. 반응형 홈페이지(온도 웹), 홍보 숏폼(온도 클립), 취업용 AI 결과물(온도 AI). 배포 주소까지 납품하고 상담과 견적은 무료입니다.",
