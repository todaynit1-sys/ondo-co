...
<section class="sec sec-mist" id="how">
  <div class="wrap">
    ...
    <div class="note-box rv">
      <b>완성된 영상은 부분 수정이 안 됩니다.</b> AI 영상은 장면 하나만 바꾸려 해도 처음부터 다시 만들어야 합니다.
      그래서 <b>3단계에서 화면 이미지와 대사를 먼저 보여 드립니다.</b>
      여기서는 몇 번이든 바꾸실 수 있고, OK하신 다음에 제작에 들어갑니다.
      완성 후에 방향을 바꾸고 싶으시면 새로 견적을 내 드립니다.
    </div>

    <div class="note-box rv">
      <b>이런 건 만들지 않습니다.</b><br>
      · 실존 인물이나 연예인의 얼굴·목소리<br>
      · 실제로 없는 메뉴·시설·자격·수상 이력<br>
      화면이 실제 매장 모습이 아닐 때는 <b>AI로 만든 영상이라고 밝히시는 편</b>이 안전합니다.
      나중에 광고 문제가 생기면 사장님 쪽으로 돌아가기 때문입니다.
    </div>
  </div>
</section>
...
body = (body
  ...
  .replace("__FAQ__", faq([
     ...
     ("AI로 만든 영상이라고 밝혀야 하나요?",
      "표기 의무는 상황에 따라 다르니 저희가 단정해 드리기는 어렵습니다. 다만 화면이 실제 매장 모습과 다를 때는 <b>영상 설명에 한 줄 넣어 두시는 편이 안전합니다.</b> 실존 인물의 얼굴·목소리는 만들지 않고, 실제로 없는 메뉴나 자격을 있는 것처럼 만들지도 않습니다."),
     ...
     ("조회수가 얼마나 나오나요?",
      "보장할 수 없습니다. 조회수는 알고리즘과 업종, 올리는 시점에 따라 크게 달라지고 한 편으로 결정되지도 않습니다. 저희가 드리는 건 <b>바로 올릴 수 있는 상태의 영상</b>까지입니다."),
     ("영상 파일은 어떤 형식으로 주시나요?",
