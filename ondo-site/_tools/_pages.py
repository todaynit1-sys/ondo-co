...
body = (body
    ...
    .replace("__FAQ__", faq([
        ...
        ("네이버나 구글 검색에 바로 나오나요?",
         "검색 등록에 필요한 기본 설정(제목·설명·구조화 데이터·공유 미리보기·검색엔진 제출)은 전부 해 드립니다. 다만 <b>검색 순위 상위 노출은 보장하지 않습니다.</b> 그건 광고비와 시간이 함께 필요한 영역입니다."),
        ...
        ("결제는 어떻게 하나요?",
         "크몽으로 오시면 크몽 결제 절차를 그대로 따르고, 카톡으로 직접 오시면 계좌 이체로 진행합니다. 소액은 완성본을 보신 뒤에, 규모가 있는 작업은 절반씩 나눠서 진행합니다."),
    ])))
